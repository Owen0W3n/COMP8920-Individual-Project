...
class Inventory:
    ...
    def add_product(self, product: Product) -> None:# reminding the program that this returns nothing
        existing = self.find_product(product.name, product.category())
        #compared the input and the exsiting data
        if existing:
            existing.increase_quantity(product.quantity)
            #add quanitty only if product already exist
        else:
    ...
    def find_product(self, name: str, category: str = None):
        #matching product by name and category if have
    ...
    def display_category(self, category: str) -> None:
        #printing product by chosen category
    ...
    def create_product_viewchoice(self):
        #user interaction for asking for desired category
        ...
        return True
## data saving and loading function
    ...
    def load_from_json(self, filename: str) -> bool:
        ...
        return True
## check the data type and value validity
    @staticmethod
